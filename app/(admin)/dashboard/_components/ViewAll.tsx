      ...
      {cows?.slice(0, limit).map((cow: Cow) => {
        ...
        return (
          ...
          >
            ...
            <div className={`flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl shadow-inner ${isFever ? 'bg-rose-50 text-rose-500' : 'bg-emerald-50 text-emerald-500'
              }`}>
            ...
            {/* Action */}
            <TransitionLink
              href={`/dashboard/herd/${cow.deviceId}`}
