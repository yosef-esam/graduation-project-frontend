    ...
    const { value: formValues } = await Swal.fire({
        ...
        <div class="flex flex-col gap-5 p-4 text-left font-poppins">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div class="space-y-1.5">
              ...
              <input id="swal-input-name" class="swal2-input !m-0 !w-full !rounded-[1.25rem] border-gray-100 font-bold !text-sm !h-14 shadow-sm" value="${entity.name || ''}" placeholder="Enter nomenclature...">
            </div>
            <div class="space-y-1.5">
              <label class="text-[10px] font-black uppercase tracking-widest text-emerald-600/60 ml-1">Species / Genus</label>
              <input id="swal-input-species" class="swal2-input !m-0 !w-full !rounded-[1.25rem] border-gray-100 font-bold !text-sm !h-14 shadow-sm" value="${entity.species || ''}" placeholder="Define genetic origin...">
            </div>
          </div>
          <div class="grid grid-cols-2 gap-5">
            <div class="space-y-1.5">
              <label class="text-[10px] font-black uppercase tracking-widest text-emerald-600/60 ml-1">Asset Age</label>
              <input id="swal-input-age" type="number" class="swal2-input !m-0 !w-full !rounded-[1.25rem] border-gray-100 font-bold !text-sm !h-14 shadow-sm" value="${entity.age}" placeholder="Age">
            </div>
            <div class="space-y-1.5">
              <label class="text-[10px] font-black uppercase tracking-widest text-emerald-600/60 ml-1">Mass (kg)</label>
              <input id="swal-input-weight" type="number" class="swal2-input !m-0 !w-full !rounded-[1.25rem] border-gray-100 font-bold !text-sm !h-14 shadow-sm" value="${entity.weight}" placeholder="Weight">
            </div>
          </div>
          <div class="space-y-1.5">
            <label class="text-[10px] font-black uppercase tracking-widest text-emerald-600/60 ml-1">Intelligence Notes</label>
      ...
      preConfirm: () => {
        return {
          ...
          age: parseInt((document.getElementById('swal-input-age') as HTMLInputElement).value),
        ...
        <div className="w-full max-w-4xl">
            <div className="mb-10 text-center">
                ...
                <div className="flex flex-wrap justify-center items-center gap-3 mb-8">
                    ...
                    <div className={`flex items-center gap-2 rounded-xl px-4 py-2 text-[11px] font-black uppercase tracking-widest border ${
                        isFever ? 'bg-rose-50 border-rose-100 text-rose-600' : 'bg-emerald-50 border-emerald-100 text-emerald-600 shadow-sm'
                    }`}>
      ...
      <div className="flex flex-col gap-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="rounded-[3rem] border border-white/20 bg-white/40 p-10 shadow-xl backdrop-blur-xl">
                ...
                <div className="space-y-6">
                    {[
                        ...
                        { label: 'Asset_Age', value: `${entity.age} yr`, icon: <MdHistory className="text-blue-500" /> },
                        { label: 'Biological_Mass', value: `${entity.weight} kg`, icon: <MdScale className="text-orange-500" /> },
                        { label: 'Registry_Date', value: entity.dateOfBirth || '2025-Q1-NULL', icon: <MdEvent className="text-purple-500" /> },
                    ].map((spec, i) => (
            ...
            <div className="rounded-[3rem] border border-white/20 bg-white/40 p-10 shadow-xl backdrop-blur-xl flex flex-col justify-center">
                ...
                <div className="rounded-2xl bg-[#023b26] p-6 font-mono text-sm font-black text-emerald-400 border border-white/10 shadow-2xl">
                    {entity.deviceId || "UNASSIGNED_STATION_DELTA_9"}
                </div>
            </div>
        </div>
            ...
            <div className="rounded-[3rem] border border-white/20 bg-white/40 p-10 shadow-xl backdrop-blur-xl relative overflow-hidden text-center">
                ...
                <div className="p-10 rounded-[2.5rem] bg-white border border-gray-100 shadow-inner">
                    <p className="text-lg font-bold text-gray-600 leading-relaxed italic">
                        &quot;{entity.notes || "The personnel matrix has provided no additional intelligence for this entity node. Synchronization with field sensors is ongoing."}&quot;
                    </p>
                </div>
            </div>
        </div>
