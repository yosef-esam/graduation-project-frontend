...
Rest,  Well Being."
            description="AfiAct II increases your herd’s pregnancy rate by providing accurate and time-sensitive heat detection. It identifies cows for insemination, and the ideal time to inseminate them."
          ...
          <Step
            ...
            description="Afimilk utilizes sophisticated antenna technology that allows the same tag to function as an effective, accurate tool for cow identification in the milking parlor and at the sorting gate."
          />
          <Step
            variant="second"
