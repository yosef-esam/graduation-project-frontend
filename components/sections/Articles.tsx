...
const Articles = () => {
  return (
    <section
      id="articles"
      className="min-h-180 xs:min-h-190 md:min-h-210 xl:min-h-175 pb-15 relative isolate flex flex-col items-center justify-center"
    >
      <div className="absolute isolate flex h-full w-full grow flex-col items-center justify-center">
        <article className="container flex flex-col text-balance py-20">
          ...
          />
          <h2 className="text-(--secondary_color) lg:max-w-1/2 text-4xl font-semibold xl:max-w-full">
            Smart Farming Insights & Articles
          </h2>

          <p className="md:max-2xl:max-w-1/2 my-4 md:max-w-2xl">
        ...
        <figure className="xs:min-h-50 mb-70 relative ml-auto mr-40 min-h-40 text-white xs:mb-20 xl:min-h-0">
          <CardSwap
            cardDistance={60}
            verticalDistance={70}
            delay={4000}
