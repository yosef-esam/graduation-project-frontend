...
const Statistics = () => {
  ...
  return (
    <section ref={ref} id="statis" className="py-20">
      <figure className="relative  isolate flex h-fit w-full items-center justify-center overflow-visible  rounded-3xl drop-shadow-[0px_0px_100px_#1788df] sm:h-[326px]">
        <Globe
          ref={globeRef}
      ...
      <h2 className="pointer-events-none my-10 px-4 text-center text-5xl font-black uppercase tracking-tighter text-gray-900 md:text-7xl mb-12">
        Biometric <span className="text-emerald-500">Intelligence</span>
      </h2>
